                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <div class="main-body">
                                <div class="page-wrapper">
                                    <!-- Page-body start -->
                                    <form action="<?= BASE_URL?>mon-hoc/quizs/luu-tao-moi" method="post">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="is_shuffle" class="form-control">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a href="<?= BASE_URL?>mon-hoc/quizs" class="btn btn-danger">Hủy</a>
                                        </div>
                                    </form>
