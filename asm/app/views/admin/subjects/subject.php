                                ...
                                <div class="page-wrapper">
                                    ...
                                    <table class="table table-stripped">
                                        <thead>
                                            ...
                                            <th colspan="2" >
                                                <a href="<?= BASE_URL?>mon-hoc/tao-moi" class="btn btn-success">Thêm mới</a>    
                                            </th>
                                        </thead>
                                        <tbody>
                                            <?php foreach ($subjects as $items) : ?>
                                                <tr>
                                                    <td><?= $items->id_subject?></td>
                                                    <td><?= $items->name_subject?></td>
                                                    <td><?= $items->name?></td>
                                                    <td><a href="<?= BASE_URL?>mon-hoc/cap-nhat?id=<?= $items->id_subject?>" class="btn btn-primary">Sửa</a></td>
                                                    <td><a href="<?= BASE_URL?>mon-hoc/xoa?id=<?= $items->id_subject?>" class="btn btn-danger">Xóa</a></td>
                                                </tr>
                                            <?php endforeach ?>
                                        </tbody>
                                    </table>
