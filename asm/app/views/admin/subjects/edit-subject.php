                        ...
                        <div class="pcoded-inner-navbar main-menu">
                            ...
                            <div class="p-15 p-b-0">
                                ...
                                <ul class="pcoded-item pcoded-left-item">
                                    <li class="active">
                                        <a href="http://localhost/we16302-php2/asm/dashboard" class="waves-effect waves-dark">
                    ...
                    <div class="pcoded-content">
                        ...
                        <div class="pcoded-inner-content">
                            ...
                            <div class="page-wrapper">
                                    ...
                                    <form action="<?= BASE_URL?>mon-hoc/luu-cap-nhat" method="post">
                                        <div class="form-group">
                                            <label for="name_subject">Tên môn học</label>
                                            <input type="text" class="form-control" name="name_subject" placeholder="Subject">
                                        </div>
                                        .<div class="form-group">
                                        ...
                                        <div class="col-12" style="text-align: center;">
                                            ...
                                            <a href="<?= BASE_URL?>mon-hoc" class="btn btn-danger">Hủy</a>
                                        </div>
                                    </form>
                                    <!-- Page-body end -->
                                </div>
